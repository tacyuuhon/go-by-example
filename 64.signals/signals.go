...
// 例如，我们希望当服务器接收到一个 SIGTERM 信号时能够自动关机，或者一个命令行工具在接收到一个 SIGINT 信号 时停止处理输入信息。
// 这里讲的就是在 Go 中如何通过通道来处理信号。
//
// [Unix 信号](https://zh.wikipedia.org/wiki/Unix%E4%BF%A1%E5%8F%B7)
//
